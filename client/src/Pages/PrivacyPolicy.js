      ...
      <Paper className={classes.paperDiv} elevation={3} >
       ...
       Privacy Policy 
        ...
        <Paper className={classes.paperDiv} elevation={3} >
          ...
          Your privacy is very important for us. Tradingcompass policy is to respect your privacy with respect to any information that we may collect from you through our website, https://tradingcompass.in , and other sites that we own and operate.<br/><br/>
